  ...
  return (
    <nav className="bg-gray-900 p-4 flex justify-between items-center">
      <ul className="flex items-center space-x-4">
        <li>
          {user ? (
            <li
              ...
              className="flex items-center cursor-pointer space-x-2 text-white"
        ...
        <li>
          <FaRegBell className="icon text-white" />
        </li>
        <Link to={"/Signup"}>
          <li className="center cursor-pointer text-white flex items-center space-x-1">
            <span>create</span>
      ...
      <ul className="flex items-center space-x-4">
        <li>
          <MdKeyboardVoice className="icon voice-icon text-white" />
        </li>
        <input
          type="text"
          placeholder="search"
      ...
      <ul className="flex items-center space-x-4">
              ...
              >
                ...
                >
                  ...
                  <g id="youtube-paths_yt20">
                    ...
                    <path d="M92.6517 11.4999C92.6517 8.51994 92.3517 6.30994 88.9217 6.30994C85.6917 6.30994 84.9717 8.45994 84.9717 11.6199V13.7899C84.9717 16.8699 85.6317 19.1099 88.8417 19.1099C91.3817 19.1099 92.6917 17.8399 92.5417 15.3799L90.2917 15.2599C90.2617 16.7799 89.9117 17.3999 88.9017 17.3999C87.6317 17.3999 87.5717 16.1899 87.5717 14.3899V13.2999H92.6517V11.4999ZM87.5917 11.2299C87.6017 9.51994 87.8417 8.16994 89.4117 8.16994C90.8917 8.16994 91.0817 9.51994 91.0717 11.1999L87.5917 11.2299Z" />
                  </g>
                </svg>
              </div>
            </span>
        ...
        <li>
          <RxHamburgerMenu className="icon text-white" />
        </li>
      </ul>
    </nav>
  );
